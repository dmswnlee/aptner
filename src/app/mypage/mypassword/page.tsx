		...
		<>
			<div className="flex flex-col items-center relative">
				...
				<div className="w-[586px] relative ">
					<Input id="password" label="현재 비밀번호" type="text" placeholder="fastcampus_v1" />
					<Input id="password" label="새 비밀번호" type="text" placeholder="fastcampus_v1" />
					<Input id="password" label="새 비밀번호 확인" type="text" placeholder="fastcampus_v1" />
