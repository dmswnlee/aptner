		...
		<>
			<div className="flex flex-col items-center relative">
				...
				<div className="w-[586px] relative ">
					<input ref={fileInputRef} className="hidden" id="userImage" type="file" accept="image/*" />
					<div className="h-[122px] w-[103px] mx-auto flex flex-col items-center">
						<div onClick={handleClick} className="w-[80px] h-[80px] rounded-full border-2 cursor-pointer"></div>
						<Button
							text="사진 변경하기"
					...
					<Input id="username" label="닉네임" type="text" placeholder="패스트캠퍼스" />
