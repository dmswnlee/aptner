    ...
    <>
      <div className="relative w-full h-full">
        ...
        <div className="w-full h-full flex flex-col justify-center items-center">
          <div className="absolute top-[364px] w-[377px] h-[116px]">
            <h2 className="text-white text-5xl font-semibold mb-4">아크로리버뷰신반포</h2>
            <p className="text-white text-[24px] font-normal leading-normal">
              여유, 행복, 그리고 경험을 가꾸는 생활을<br />차원이 다른 프리미엄으로 이야기합니다.
            </p>
          </div>
