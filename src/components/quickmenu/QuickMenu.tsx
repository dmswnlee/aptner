...
const QuickMenu = () => {
  return (
    <div className="fixed right-20 top-1/3 flex flex-col items-center gap-2 p-4 rounded-lg transition-all duration-300 group hover:bg-[#FAFAFA] hover:shadow-lg hover:w-48 bg-transparent">
      <div className="flex items-center gap-3 w-full hover:bg-[#EBF7FF] p-1 hover:rounded-3xl hover:w-[170px]">
      ...
      <div className="flex items-center gap-4 w-full hover:bg-[#EBF7FF] p-1 hover:rounded-3xl hover:w-[170px]">
